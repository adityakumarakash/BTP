function [time, wFinal, perf] = OpJACPrimalDual_Mex(XTrain, yTrain, XTest, yTest, options)
    C = options.C;
    ...
    wInter = OpJACPrimalDual_C(XTrain,yTrain,p,wInit,C,ticSpacing,numPasses,upperBoundL2);
