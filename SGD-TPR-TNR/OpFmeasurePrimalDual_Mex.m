function [time, wFinal, perf] = OpFmeasurePrimalDual_Mex(XTrain, yTrain, XTest, yTest, options)
    C = options.C;
    ...
    wInter = OpFmeasurePrimalDual_C(XTrain,yTrain,p,wInit,C,ticSpacing,numPasses,upperBoundL2);
