function [time, wFinal, perf] = OpQMeanPrimalDual_Mex(XTrain, yTrain, XTest, yTest, options)
    C = options.C;
    ...
    wInter = OpQMeanPrimalDual_C(XTrain,yTrain,p,wInit,C,ticSpacing,numPasses,upperBoundL2);
